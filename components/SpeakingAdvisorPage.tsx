...
const SpeakingAdvisorPage = () => {
  ...
  return (
    <div className="min-h-screen pt-[80px]" style={{ backgroundColor: '#F5EFE6' }}>
      {/* Hero Section */}
      <section className="px-4 md:px-[70px] py-12 md:py-16 lg:py-20 " style={{ backgroundColor: data.heroBackground }}>
        ...
        <p className="text-base md:text-[26px] text-gray-700 leading-relaxed" style={{ fontFamily: 'Poppins, sans-serif' }}>
          Sari Kusumaningrum speaks and advises on the intersection of leadership, <br /> reputation, and global connectivity.
        </p>
        <div className="py-4">
      ...
      <div className=" px-4 md:px-[70px] py-[128px] ">
