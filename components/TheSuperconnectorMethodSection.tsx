  ...
  return (
    <section className="w-full overflow-hidden">
      <div className="w-full bg-[#f3eee7]">
        <div className="w-full max-w-[1440px] mx-auto flex flex-col-reverse md:flex-row items-center px-6 md:px-12 lg:px-[72px] pt-8 md:pt-10 pb-0 min-h-[500px] md:h-[618px] relative overflow-hidden">
          ...
          <div className="w-full md:w-[45%] flex justify-center md:items-end h-[400px] md:h-full relative overflow-visible">
            <img
              src={imageSrc}
              alt={title}
              className="absolute bottom-0 md:bottom-[-20px] h-[100%] w-auto object-contain object-bottom scale-[1.15] md:scale-[1.3] lg:scale-[1.45] origin-bottom"
            />
          </div>
        </div>
      </div>
