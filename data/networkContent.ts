export const networkItems = [
  {
    ...
    content: [
      ...
      "With strong operational frameworks, a focus on proprietary technology, and the agility of an independent company, Archipelago continues to redefine modern hospitality and support ambitious tourism growth across the regions it serves."
    ],
    learnMoreUrl: "https://www.archipelagointernational.com"
  },
  {
    id: "kadin",
    ...
    detailImage: "/images/kadinIndonesia.png",
    content: [
      ...
      "Through its extensive network and global partnerships, KADIN plays a key role in facilitating bilateral and multilateral cooperation, supporting sustainable economic development, and positioning Indonesia as a dynamic hub for business and investment."
    ],
    learnMoreUrl: "https://kadin.id"
  },
  {
    ...
    platforms: [
      {
        name: "thesmedia.id",
        description: "Indonesia's premier English-language digital media platform, catering to 'Generation NOW' and affluent consumers, providing engaging and insightful content across various topics.",
        url: "https://thesmedia.id"
      },
      {
        name: "rsvpclique.com",
        description: "The ultimate event guide and online media platform, offering comprehensive coverage and insights into the latest events, lifestyle, and happenings.",
        url: "https://rsvpclique.com"
      },
      {
        name: "rsvpjakarta.com",
        description: "A dynamic and integrated communications agency specializing in public relations, events, content creation, and brand strategy. RSVP Jakarta delivers innovative solutions to enhance brand presence and engagement.",
        url: "https://rsvpjakarta.com"
      }
    ],
    footer: "THE S MEDIA GROUP committed to delivering high-quality content and exceptional communication services, positioning it as a key player in Indonesia's digital media landscape."
  }
];
