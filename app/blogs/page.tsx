    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#F9F7F2] pt-[80px]">
      <main className="flex-grow pt-[40px] pb-[80px] px-[16px] md:px-[70px]">
        ...
        <p className="font-[family-name:var(--font-poppins)] text-[20px] md:text-[24px] lg:text-[28px] leading-[1.4] text-[#1A1A1A] mb-12 max-w-[1000px]">
          Insights and reflections on <span className="font-bold text-[#FE5001] md:text-[30px] font-[family-name:var(--font-cormorant)]">leadership, reputation,</span> and <span className="font-bold text-[#FE5001] md:text-[30px] font-[family-name:var(--font-cormorant)]">the power</span> of <span className="font-bold text-[#FE5001] md:text-[30px] font-[family-name:var(--font-cormorant)]">strategic relationship</span> in a connected world.
        </p>
